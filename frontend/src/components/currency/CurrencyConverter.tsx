...
export function CurrencyConverter({ preferredCurrencyCode }: CurrencyConverterProps) {
  const { user } = useAuth();
  const [isOpen, setIsOpen] = useState(false);
  const [selectedCurrency, setSelectedCurrency] = useState(preferredCurrencyCode);
